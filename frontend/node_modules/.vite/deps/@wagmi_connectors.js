...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/baseAccount.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-ZC5V6HFU.js");
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/coinbaseWallet.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-A3XE7FEM.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-OG4OTAK3.js");
...
// node_modules/.pnpm/@gemini-wallet+core@0.2.0_viem@2.38.2_bufferutil@4.0.9_typescript@5.6.3_utf-8-validate@5.0.10_zod@4.1.12_/node_modules/@gemini-wallet/core/dist/index.js
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/gemini.js
gemini.type = "gemini";
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/metaMask.js
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-ZY6YSHBL.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/porto.js
function porto(parameters = {}) {
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getProvider() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-TNKOGBTQ.js");
          return Porto.create({
            ...parameters,
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/safe.js
safe.type = "safe";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-QCEDWHF3.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-SKDQKVJG.js");
...
// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/version.js
var version2 = "5.11.2";

// node_modules/.pnpm/@wagmi+connectors@5.11.2_@tanstack+react-query@5.90.3_react@18.3.1__@types+react@18.3.26_@wag_xonlgissheqoavnkttulvm6724/node_modules/@wagmi/connectors/dist/esm/walletConnect.js
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-AWB7F2QF.js");
